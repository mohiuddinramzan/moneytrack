    ...
    return `<div class="card">
      <div class="card__header">
        ...
        <div class="row-actions">
          <button class="btn btn-icon btn-ghost btn-sm" data-edit-account="${acc.id}" aria-label="Edit account">${icon("settings")}</button>
          <button class="btn btn-icon btn-ghost btn-sm" data-delete-account="${acc.id}" aria-label="Delete account">${icon("x")}</button>
        </div>
      </div>
